 ...
 */
     ...
     */
        ...
        private static IEnumerator NewEase(Function ease, Vector3 start, Vector3 end, float total,
            IEnumerable<float> driver)
        {
            Vector3 distance = end - start;
            return driver.Select(i => Ease(ease, start, distance, i, total)).GetEnumerator();
        }
     ...
     */
        ...
        private static IEnumerable<Vector3> NewBezier<T>(Function ease, IList nodes, ToVector3<T> toVector3,
            float maxStep, IEnumerable<float> steps)
        {
