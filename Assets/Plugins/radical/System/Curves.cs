...
namespace Assets.Plugins.radical.System
{
    ...
    public static class Spline
    {
        ...
        public static void GizmoDraw(Transform[] pts, float t,EasingType ease = EasingType.Linear, bool easeIn = true, bool easeOut = true) 
        {
            ...
            GizmoDraw(v, t, ease, easeIn, easeOut);
        }
